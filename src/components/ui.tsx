...
export function SectionCard({
  ...
  return (
    <section className={`rounded-2xl bg-white p-5 shadow-sm ring-1 ring-sand sm:p-6 ${className}`}>
...
export function ErrorState({
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-sand">
...
export function SkeletonCard() {
  return (
    <div className="animate-pulse rounded-2xl bg-white p-5 shadow-sm ring-1 ring-sand" aria-hidden>
